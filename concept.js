document.addEventListener('DOMContentLoaded', function () {
  ...
  /* Null-checks: het taalensysteem bestaat niet op alle versies van de pagina.
     Zonder deze checks crasht het script hier en werkt het formulier NIET meer. */
  if (taalDropdown) {
  ...
  if (taalEigenAdd) {
    taalEigenAdd.addEventListener('click', function () {
      if (taalEigen) { voegTaalToe(taalEigen.value); taalEigen.value = ''; }
    });
  }
