...
GA_MEASUREMENT_ID = 'G-ZS7GHNBJXD'
...
# ── SVG-lijniconen (Feather-stijl), consistent met exp-card iconen.
# Vervangt emoji zodat het geen "AI-gegenereerde" indruk meer wekt.
ICON = {
    'check':    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6L9 17l-5-5" pathLength="1"></path></svg>',
    ...
    'lock':     '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" pathLength="1"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4" pathLength="1"></path></svg>',
    'mobile':   '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="2" width="12" height="20" rx="2" pathLength="1"></rect><line x1="11" y1="18" x2="13" y2="18" pathLength="1"></line></svg>',
    'search':   '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8" pathLength="1"></circle><line x1="21" y1="21" x2="16.65" y2="16.65" pathLength="1"></line></svg>',
    'handshake':'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 17l-3.5-3.5a2 2 0 0 1 0-2.8v0a2 2 0 0 1 2.8 0L13 13" pathLength="1"></path><path d="M13 13l2 2a2 2 0 0 0 2.8 0v0a2 2 0 0 0 0-2.8L14 8.4" pathLength="1"></path><path d="M2 12l4-4 3 1 3-3 4 4-3 3-2-1-3.5 3.5" pathLength="1"></path><path d="M22 12l-4-4-2 1" pathLength="1"></path></svg>',
    'trend':    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18" pathLength="1"></polyline><polyline points="17 6 23 6 23 12" pathLength="1"></polyline></svg>',
    'mail':     '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16v16H4z" pathLength="1"></path><path d="M22 6l-10 7L2 6" pathLength="1"></path></svg>',
    'pin':      '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" pathLength="1"></path><circle cx="12" cy="10" r="3" pathLength="1"></circle></svg>',
    'clock':    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10" pathLength="1"></circle><polyline points="12 6 12 12 16 14" pathLength="1"></polyline></svg>',
    'calendar': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" pathLength="1"></rect><line x1="16" y1="2" x2="16" y2="6" pathLength="1"></line><line x1="8" y1="2" x2="8" y2="6" pathLength="1"></line><line x1="3" y1="10" x2="21" y2="10" pathLength="1"></line></svg>',
    'timer':    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="13" r="8" pathLength="1"></circle><path d="M12 9v4l2 2" pathLength="1"></path><path d="M9 2h6" pathLength="1"></path></svg>',
    'stopwatch':'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="13" r="8" pathLength="1"></circle><path d="M12 9v4l2 2" pathLength="1"></path><path d="M9 2h6" pathLength="1"></path></svg>',
    'rocket':   '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z" pathLength="1"></path><path d="M12 15l-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z" pathLength="1"></path><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0" pathLength="1"></path><path d="M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5" pathLength="1"></path></svg>',
    ...
    'user':     '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" pathLength="1"></path><circle cx="12" cy="7" r="4" pathLength="1"></circle></svg>',
}

def icon(name, cls=''):
    return f'<span class="icon-svg {cls}" aria-hidden="true">{ICON[name]}</span>'
...
{switch_items_html}
        ...
        <a href="{prefix}/concept.html" class="nav__cta--gratis"><span>{n['cta_gratis']}</span></a>
        <span class="nav__cta--contact">{nav['contact']}</span>
      ...
      <div class="container">
        ...
        <div class="spotlight reveal">
          ...
          <div class="spotlight__quote">
            ...
            <div class="spotlight__stars" aria-label="5 / 5">{(icon("star")+' ')*5}</div>
            ...
            <a href="{prefix}/blog/5-redenen-trage-website.html" class="blog-card__link">
              ...
              <div class="blog-card__body">
                ...
                <div class="blog-card__meta">
                  <span>{icon("calendar")} {blog['p1_date']}</span>
                  <span>{icon("stopwatch")} 5 {blog['min_read']}</span>
                </div>
              </div>
            </a>
          </article>
          <article class="blog-card reveal reveal--delay-2">
            <a href="{prefix}/blog/seo-basis-mkb.html" class="blog-card__link">
              ...
              <div class="blog-card__body">
                ...
                <p>{blog['p2_text']}</p>
                <div class="blog-card__meta">
                  <span>{icon("calendar")} {blog['p2_date']}</span>
                  <span>{icon("stopwatch")} 7 {blog['min_read']}</span>
                </div>
              </div>
            </a>
          </article>
          <article class="blog-card reveal reveal--delay-3">
            <a href="{prefix}/blog/mkb-westland-online-groeien.html" class="blog-card__link">
              ...
              <div class="blog-card__body">
                ...
                <p>{blog['p3_text']}</p>
                <div class="blog-card__meta">
                  <span>{icon("calendar")} {blog['p3_date']}</span>
                  <span>{icon("stopwatch")} 5 {blog['min_read']}</span>
                </div>
              </div>
            </a>
      ...
      <div class="container">
        ...
        <div class="grid--3">
          <div class="garantie-kaart garantie-kaart--teal reveal reveal--delay-1">
            <div class="garantie-kaart__icon">{icon("check")}</div>
            <h3>{gar['g1_title']}</h3>
            <p>{gar['g1_text']}</p>
          </div>
          <div class="garantie-kaart reveal reveal--delay-2">
            <div class="garantie-kaart__icon">{icon("bolt")}</div>
            <h3>{gar['g2_title']}</h3>
            <p>{gar['g2_text']}</p>
          </div>
          <div class="garantie-kaart garantie-kaart--teal reveal reveal--delay-3">
            <div class="garantie-kaart__icon">{icon("lock")}</div>
            <h3>{gar['g3_title']}</h3>
            <p>{gar['g3_text']}</p>
          </div>
          <div class="garantie-kaart reveal reveal--delay-1">
            <div class="garantie-kaart__icon">{icon("mobile")}</div>
            <h3>{gar['g4_title']}</h3>
            <p>{gar['g4_text']}</p>
          </div>
          <div class="garantie-kaart garantie-kaart--teal reveal reveal--delay-2">
            <div class="garantie-kaart__icon">{icon("search")}</div>
            <h3>{gar['g5_title']}</h3>
            <p>{gar['g5_text']}</p>
          </div>
          <div class="garantie-kaart reveal reveal--delay-3">
            <div class="garantie-kaart__icon">{icon("handshake")}</div>
            <h3>{gar['g6_title']}</h3>
            <p>{gar['g6_text']}</p>
          </div>
        </div>
          ...
          <div class="about-text">
            ...
            <div class="values">
              <div class="value-item">
                <span class="value-item__icon">{icon("bolt")}</span>
                <div><h3>{mis['v1_title']}</h3><p>{mis['v1_text']}</p></div>
              </div>
              <div class="value-item">
                <span class="value-item__icon">{icon("handshake")}</span>
                <div><h3>{mis['v2_title']}</h3><p>{mis['v2_text']}</p></div>
              </div>
              <div class="value-item">
                <span class="value-item__icon">{icon("trend")}</span>
                <div><h3>{mis['v3_title']}</h3><p>{mis['v3_text']}</p></div>
              </div>
              <div class="value-item">
                <span class="value-item__icon">{icon("lock")}</span>
            ...
            <a href="{prefix}/blog/{post['slug']}" class="blog-card__link">
              ...
              <div class="blog-card__body">
                ...
                <div class="blog-card__meta">
                  ...
                  <span>{icon("stopwatch")} {post['min']} {d['min_read']}</span>
                </div>
              </div>
            </a>
          </article>''')
        ...
        <div class="contact-split reveal">
          ...
          <div>
            <div class="contact-info">
              ...
              <div class="info-item">
                <div class="info-icon">{icon("timer")}</div>
                <div>
